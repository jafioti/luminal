...
fn test_contiguous() {
    ...
    cx.compile(CudaFp32Compiler::default(), &mut b);
    cx.execute();
...
fn test_rotate() {
    ...
    cx.compile(CudaFp32Compiler::default(), &mut rotated_a);
    cx.execute();
...
fn test_constant() {
    ...
    cx.compile(CudaFp32Compiler::default(), &mut a);
...
fn test_add() {
    ...
    cx.compile(CudaFp32Compiler::default(), &mut c);
    cx.execute();
...
fn test_square() {
    ...
    cx.compile(<(GenericCompiler, CudaFp32Compiler)>::default(), &mut b);
    cx.execute();
...
fn test_sum_reduce() {
    ...
    cx.compile(CudaFp32Compiler::default(), (&mut b, &mut c, &mut d));
    cx.execute();
...
fn test_sum_reduce2() {
    ...
    cx.compile(CudaFp32Compiler::default(), &mut d);
    cx.execute();
...
fn test_batch_matmul_transpose() {
    ...
    cx.compile(
        <(GenericCompiler, CudaFp32Compiler)>::default(),
...
fn test_common_buffer() {
    ...
    cx.compile(CudaFp32Compiler::default(), (&mut b, &mut c));
    cx.execute();
}
...
fn test_embedding() {
    ...
    cx.compile(CudaFp32Compiler::default(), (&mut b, &mut batch_out));
    cx.execute();
...
fn test_pad_contig() {
    ...
    cx.compile(CudaFp32Compiler::default(), (&mut a, &mut b, &mut c));
    cx.execute();
